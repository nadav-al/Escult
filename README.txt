Thing To Add:
1. Cat visible behind girl.
2. Cat intreacts with well to get souls.
3. "Light" switch - turn on/off.
4. Make inverse colliders - a path that you cant walk out of.
5. At the beggining of each stage, summon the cat via some animation.
